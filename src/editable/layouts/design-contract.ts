...
export const editableRootStyle = {
  // Boldway-inspired system: warm cream backgrounds, bold red accent, near-black
  // text, clean hairline borders. Premium and modern agency aesthetic.
  '--slot4-page-bg': '#F5F4EF',
  '--slot4-page-text': '#111111',
  '--slot4-panel-bg': '#EDECEA',
  ...
  '--editable-footer-bg': '#F5F4EF',
  '--editable-footer-text': '#111111',
} as CSSProperties
