export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'starhardware',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Starhardware',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'starhardware.co.in',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://starhardware.co.in',
